...
<div class="row-fluid">
 <div style="float:left;width:430px;">
  	<?php
		...
		$this->widget('application.widgets.charting.CBarsChartWidget', 
				 array(	'id'=>'columnchart-count-files-month',
						'theme'=>'Distinctive',
						'title'=>'',
...
<div style="float:left;width:430px;">
	...
	'columns'=>array('identifier','name','collection_name',array('header'=>'Main contact','value'=>'$data->getShortContact()',),
	),
	)); 
	$this->endWidget();?>
	</div>
	<div style="float:left;width:430px;padding-left:10px;">
  	<?php
		...
		$this->widget('application.widgets.charting.CBarsChartWidget', 
				 array(	'id'=>'columnchart-count-month',
						'theme'=>'Distinctive',
						'title'=>'',
