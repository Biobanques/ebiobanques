...
EXTERNAL_DATA_PATH="/var/www/dumps/interop/"
CURRENTPATH=$(pwd)
...
#dump file
DUMP_FILE=$EXTERNAL_DATA_PATH"15-03-2016/interop/"
#host and port
...
#java -jar selenium-server-standalone-2.44.0.jar -log selenium_adm.log -htmlSuite "*googlechrome" $SERVERURL $CURRENTPATH"/dev/testsSuites/administrationTestSuite.html" $CURRENTPATH"/results_administration.html"

#java -jar selenium-server-standalone-2.44.0.jar -log selenium_mbb.log -htmlSuite "*googlechrome" $SERVERURL $CURRENTPATH"/dev/testsSuites/managerBiobankTestSuite.html" $CURRENTPATH"/results_manager_biobanque.html"

#java -jar selenium-server-standalone-2.44.0.jar -log selenium_mbb.log -htmlSuite "*googlechrome" $SERVERURL $CURRENTPATH"/dev/testsSuites/simpleUserTestSuite.html" $CURRENTPATH"/results_simple_user.html"
