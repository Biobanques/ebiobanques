<div style="padding: 5px;border:1px solid blueviolet;background-color: #D8E4F1;">
    <img src="<?php echo Yii::app()->request->baseUrl.'/images/';?>information.gif"/><div style="display: inline;margin-left: 5px;"><b>Comment effectuer votre recherche, mode simple ou avancé?</b></div>
